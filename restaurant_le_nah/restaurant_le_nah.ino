...
void loop() {
  ...
  // This makes the loop robust against timing errors.
  pressButton(BTN_B, 100);
  delay(500);
  pressButton(BTN_B, 100);
  delay(500);
  ...
  delay(1000); // Adjusted delay for opening map
  ...
  // Navigate
  moveStick(150, STICK_RIGHT, 40);
  resetStick();
  delay(300);

  // Select
  pressButton(BTN_A, 100);
  delay(2000); // Adjusted delay for confirm dialog

  // Confirm
  pressButton(BTN_A, 100);

  // Wait for fast travel
  delay(12000); // Adjusted delay for fast travel
}